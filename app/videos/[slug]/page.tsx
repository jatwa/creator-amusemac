...
export async function generateMetadata({
  ...
  return {
    title: `${video.title} | Creator by Amusemac`,
    ...
    <article className="space-y-12">
        ...
        <header className="space-y-4 border-b border-line pb-8">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pt-2">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <a
                  ...
                  className="text-xs text-lime underline hover:text-white"
                >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-1.5 rounded-xl border border-line bg-panel px-4 py-2 text-xs font-semibold text-zinc-200 hover:border-lime hover:text-white transition"
            >
              Watch on {video.platform === "youtube" ? "YouTube" : "Original Platform"} ↗
            </a>
          </div>
        </header>
      </div>
      ...
      <div className="grid gap-12 lg:grid-cols-4">
        ...
        <div className="lg:col-span-3 space-y-8">
          ...
          <div className="rounded-xl border border-line bg-black/40 p-4 text-xs text-zinc-400">
